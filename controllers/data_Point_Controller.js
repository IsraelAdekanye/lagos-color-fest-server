...
<head>
    ...
    <title>Lagos Color Fest</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: left;">
			            <h1><a href="#">Hello ${firstName},</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Delectus amet inventore maiores consectetur ullam magnam?</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</span></li>
					                <li><span class="text">(+234) 818 8217 475</span></a></li>
					              </ul>
                      </td>
                    </tr>
                  </table>
